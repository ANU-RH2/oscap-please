...
* 4. Improvements *************************************************************
	oscap-please is in very early stages and there are many improvements to be made, including
		...
		* More user customisation options in cfg, including ability to filter out machines which perform above/below a certain benchmark, ability to group machines etc.
